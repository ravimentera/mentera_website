      ...
      <div className="relative w-full max-w-[20rem] sm:max-w-[25rem] md:max-w-[28rem] lg:max-w-[31.25rem] aspect-square flex items-center justify-center overflow-visible flex-wrap ">
        ...
        >
          ...
          >
            ...
            <circle cx="250" cy="250" r="280" fill="none" stroke="url(#ringGradient1)" strokeWidth="2" />
          </svg>

          {[
            { src: "/app-logos/app-drchrono.png", alt: "DrChrono", pos: "-top-6 sm:-top-7 md:-top-8 left-1/2 -translate-x-1/2" },
            { src: "/app-logos/app-gmail.png", alt: "Gmail", pos: "top-1/2 -right-6 sm:-right-7 md:-right-8 -translate-y-1/2" },
            { src: "/app-logos/app-hubspot.png", alt: "HubSpot", pos: "-bottom-6 sm:-bottom-7 md:-bottom-8 left-1/2 -translate-x-1/2" },
            { src: "/app-logos/app-athenahealth.png", alt: "Athenahealth", pos: "top-1/2 -left-6 sm:-left-7 md:-left-8 -translate-y-1/2" },
          ].map((icon) => (
            <m.div
              key={icon.alt}
              className={`absolute w-12 h-12 sm:w-14 sm:h-14 md:w-[60px] md:h-[60px] ${icon.pos}`}
              animate={{ rotate: -360 }}
              transition={{ duration: 60, repeat: Infinity, ease: "linear" }}
            >
        ...
        >
          ...
          >
            ...
            <circle cx="250" cy="250" r="200" fill="none" stroke="url(#ringGradient2)" strokeWidth="2" />
          </svg>

          {[
            { src: "/app-logos/app-teams.png", alt: "Microsoft Teams", pos: "top-8 sm:top-10 md:top-12 left-1/2 -translate-x-1/2" },
            { src: "/app-logos/app-google-drive.png", alt: "Google Drive", pos: "bottom-32 sm:bottom-40 md:bottom-52 left-6 sm:left-8 md:left-12" },
            { src: "/app-logos/app-slack.png", alt: "Slack", pos: "bottom-32 sm:bottom-40 md:bottom-52 right-6 sm:right-8 md:right-12" },
          ].map((icon) => (
            <m.div
              key={icon.alt}
              className={`absolute w-12 h-12 sm:w-14 sm:h-14 md:w-[60px] md:h-[60px] ${icon.pos}`}
        ...
        <div className="relative z-10 w-40 h-40 sm:w-48 sm:h-48 md:w-64 md:h-64">
          <div className="w-full h-full relative rounded-full overflow-hidden">
            ...
            >
              <source src="/videos/orb-mobile.webm" type="video/webm" media="(max-width: 768px)" />
              <source src="/videos/orb-optimized.webm" type="video/webm" />
            </video>
            {isMobile && (
              <>
                <div
        ...
        >
          ...
          >
            ...
            <h2 className="text-zinc-950 font-bold text-base sm:text-lg mb-3 sm:mb-4 leading-snug">
            ...
            <div className="space-y-2 sm:space-y-3">
              {[
                ...
                <div key={text} className="flex items-start gap-2 sm:gap-3">
                  ...
                  <p className="text-zinc-900 text-xs sm:text-sm leading-relaxed">{text}</p>
                </div>
              ))}
            </div>
          </div>
